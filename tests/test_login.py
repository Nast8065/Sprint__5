...
class TestLogin:
    ...
    def test_login_in_login_btn_success(self, driver): # Вход в личный кабинет через кнопку "Войти в аккаунт" на главной странице
        ...
        assert (driver.current_url == URLS.MAIN_PAGE_URL) and (order_btn == Texts.ORDER_BUTTON_TEXT)

    def test_login_in_personal_account_btn_success(self, driver): # Вход в личный кабинет через кнопку "Личный кабинет" на главной странице
        driver.get(URLS.MAIN_PAGE_URL)
    ...
    def test_login_in_registration_form_success(self, driver): # Вход в личный кабинет через форму регистрации
    ...
    def test_login_in_recover_form_success(self, driver): # Вход в личный кабинет через форму восстановления
